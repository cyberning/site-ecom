...
test.describe("Admin Auth", () => {
  // Ce bloc soumet le formulaire de login admin. NextAuth v5 beta utilise un
  // CSRF token global au serveur : on sérialise pour éviter que ces tests ne
  // s'invalident mutuellement les tokens quand ils tournent en parallèle.
